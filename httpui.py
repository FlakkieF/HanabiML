...
# AIClasses
ais = {"random": hanabi.Player, "inner": hanabi.InnerStatePlayer, "outer": hanabi.OuterStatePlayer, "self": hanabi.SelfRecognitionPlayer, "intentional": hanabi.IntentionalPlayer,  "intentionalML": hanabi.IntentionalPlayerML,"full": hanabi.SelfIntentionalPlayer}
...
class MyHandler(BaseHTTPServer.BaseHTTPRequestHandler):
    ...
    def perform_response(s):
        ...
        if gid is None or game is None or path.startswith("/restart/"):
            ...
            s.wfile.write('<li><a href="/new/intentionalML">Intentional Player Machine Learning</a></li>\n')
